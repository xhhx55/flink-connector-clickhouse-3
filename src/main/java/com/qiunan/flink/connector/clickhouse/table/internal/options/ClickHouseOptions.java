package com.qiunan.flink.connector.clickhouse.table.internal.options;
...
public class ClickHouseOptions implements Serializable {
    ...
    private ClickHouseOptions(String url, String username, String password, String databaseName, String tableName, int batchSize, Duration flushInterval, int maxRetires, boolean writeLocal, String partitionStrategy, String partitionKey, boolean ignoreDelete) {
        this.url = url;
