package com.qiunan.flink.connector.clickhouse.table.internal.executor;
...
public class ClickHouseUpsertExecutor implements ClickHouseExecutor{
    ...
    @Override
    public void prepareStatement(ClickHouseConnectionProvider clickHouseConnectionProvider) {
    }
    ...
    @Override
    public void addBatch(RowData rowData) {
    ...
    public void closeStatement() throws SQLException {
        ...
        List<ClickHousePreparedStatement> clickHousePreparedStatements = Arrays.asList(this.insertStmt, this.updateStmt, this.deleteStmt);
