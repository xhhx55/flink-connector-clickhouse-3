    ...
    public static class Builder{
        ...
        private ClickHouseBatchSinkFunction createBatchSinkFunction(ClickHouseRowConverter converter) {
            ...
            if (this.primaryKey.isPresent() && !this.options.getIgnoreDelete()) {
                clickHouseExecutor = ClickHouseExecutor.createUpsertExecutor(
                ...
                clickHouseExecutor = new ClickHouseBatchExecutor(sql,
                        converter,
            ...
            return new ClickHouseBatchSinkFunction(new ClickHouseConnectionProvider(this.options), clickHouseExecutor, this.options);
        }
